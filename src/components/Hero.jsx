...
const Hero = () => {
    ...
    const totalVideos = 3;
    const nexVideoRef = React.createRef(null);
    // 0 % 4 = 0 + 1 => 1
    // 1 % 4 = 1 + 1 => 2
    // 2 % 4 = 2 + 1 => 3
    // 3 % 4 = 3 + 1 => 4
    ...
    return (
        <div className='relative h-dvh w-screen overflow-x-hidden'>
            {isLoading && (
                <div className='flex-center absolute z-[100] h-dvh w-screen overflow-hidden bg-violet-50 '>{/* wait unitl videos load */}
                ...
                <div className='absolute left-0 top-0 z-40 size-full'>
                    <div className='mt-24 px-5 sm:px-10'>
                        ...
                        <p className='mb-5 max-w-64 font-robert-regular text-blue-100'>
                            Enter de Metagame layer <br />
                            Unleash the Play Econommy
                        </p>
